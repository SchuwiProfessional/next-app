...
export default function ProductsPage() {
  ...
  const handleEditProduct = (e) => {
    ...
    if (editingProductUuid) {
      ...
      fetch(`http://localhost:3002/edit/${editingProductUuid}`, {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
        },
      ...
      <div className="px-4 py-2">
        ...
        {isFormVisible && (
          <div className="" style={{ width: "60%", margin: "auto" }}>
            <form
              className="form-container border border-gray-350 rounded-md mr-4"
              style={{ height: "93vh" }}
            >
              ...
              <div className="flex justify-center space-x-8">
                ...
                <button
                  ...
                  type="submit"
                  onClick={
                    editingProductUuid ? handleEditProduct : handleAddProduct
                  }
                >
